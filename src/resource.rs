...
pub static FONT_PATHS: Lazy<HashMap<&'static str, Path>> = Lazy::new(|| {
  ...
  m.insert(
    "z",
    Path::parse("M -168.5 -123.5 L -168.5 -245.5 L 222 -245.5 L -181 214 L 222 214 L 222 87.5 ")
      .expect("invalid path"),
  );
  ...
  m.insert(
    "L",
    Path::parse(
      "M -217.2 -346.5 L 6 -346.5 L -113 -346.5 L -113 311.9 L -214 311.9 L 255 311.9 L 255 173.5 ",
    )
    .expect("invalid path"),
  );
  ...
  m.insert(
    "Z",
    Path::parse("M -203 -201.5 L -203 -346.5 L 266 -346.5 L -212.5 311.9 L 251 311.9 L 251 176.5 ")
      .expect("invalid path"),
  );
